...
<a href="index.php?page=pastry">pie & Pastry</a> |
Pemesanan

<div class="row">

  <div class="col-sm-4">
  	<img src="gambar/pastry4.png">
  </div>


  <div class="col-sm-8">
    <h2>APPLE CREAMCHEESE PASTRY</h2><br>
    <h5>
    	Pastry lembut dengan filling apple jam dan creamcheese
    </h5>
    <h4>Rp 13.000/piece</h4><br><br>
