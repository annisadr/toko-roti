...
<a href="index.php?page=rbread">Regular Bread</a> |
Pemesanan

<div class="row">

  <div class="col-sm-4">
  	<img src="gambar/bread11.jpg">
  </div>


  <div class="col-sm-8">
    <h2>CHEESE VOLCANO</h2><br>
    <h5>
    	Roti keju lembut dan gurih, berisi potongan keju cheddar dengan topping taburan bubuk parmesan yang melimpah
    </h5>
    <h4>Rp 8.000/piece</h4><br><br>
